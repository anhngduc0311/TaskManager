...
Tài liệu này hướng dẫn bạn cách đóng gói toàn bộ hệ thống **TaskManager** (bao gồm Backend .NET 8, Frontend Angular 18+ và Database SQL Server 2022) bằng **Docker** và **Docker Compose**, sau đó triển khai lên máy chủ **Ubuntu Server**.
...
* Sử dụng `.NET SDK 8.0` để build và publish ứng dụng ở chế độ Release.
* Sử dụng `.NET ASP.NET 8.0` runtime nhỏ gọn để chạy ứng dụng.
